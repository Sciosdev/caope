    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('consultorios.update', $reserva) }}" class="row g-3">
                ...
                <div class="col-md-8"><label class="form-label">Estrategia</label><input type="text" name="estrategia" class="form-control" value="{{ old('estrategia', $reserva->estrategia) }}" required></div>
