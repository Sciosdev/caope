...
class ExpedienteController extends Controller
{
    ...
    private function prepareExpedienteColumns(array $data, Expediente $reference, bool $applyDefaults = true): array
    {
        ...
        $columnDefaults = [
            'clinica' => static fn () => null,
            'recibo_expediente' => static fn () => null,
            'recibo_diagnostico' => static fn () => null,
            'genero' => static fn () => null,
            'estado_civil' => static fn () => null,
            'ocupacion' => static fn () => null,
            'escolaridad' => static fn () => null,
            'fecha_nacimiento' => static fn () => null,
            'lugar_nacimiento' => static fn () => null,
            'domicilio_calle' => static fn () => null,
            'colonia' => static fn () => null,
            'delegacion_municipio' => static fn () => null,
            'entidad' => static fn () => null,
            'telefono_principal' => static fn () => null,
            'fecha_inicio_real' => static fn () => null,
            'motivo_consulta' => static fn () => null,
            'alerta_ingreso' => static fn () => null,
            'contacto_emergencia_nombre' => static fn () => null,
            'contacto_emergencia_parentesco' => static fn () => null,
            'contacto_emergencia_correo' => static fn () => null,
            'contacto_emergencia_telefono' => static fn () => null,
            'contacto_emergencia_horario' => static fn () => null,
            'medico_referencia_nombre' => static fn () => null,
            'medico_referencia_correo' => static fn () => null,
            'medico_referencia_telefono' => static fn () => null,
